...
# HC-SR04 TRIG Output ? JA1_P (Pin F14)
set_property PACKAGE_PIN J13 [get_ports trig]
set_property IOSTANDARD LVCMOS33 [get_ports trig]

# HC-SR04 ECHO Input (via voltage divider) ? JA2_P (Pin H14)
set_property PACKAGE_PIN J14 [get_ports echo]
set_property IOSTANDARD LVCMOS33 [get_ports echo]

set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS33} [get_ports {alert_o}];
